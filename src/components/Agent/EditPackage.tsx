...
const EditPackage = () => {
  ...
  const removeItineraryDay = (index: number) => {
    if (!packageData) return;
    const updatedItinerary = packageData.itinerary.filter(
      (_, i) => i !== index
    );
    setPackageData({ ...packageData, itinerary: updatedItinerary });
  };
  ...
  const addItineraryDay = () => {
    ...
    setPackageData({
      ...packageData,
      itinerary: [...packageData.itinerary, newItinerary],
    });
  };
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {errors.totalCapacity && (
                <p className="text-red-500">{errors.totalCapacity}</p>
              )}
            </div>
            <div>
            ...
            {images.map((file, index) => (
              <div key={index} className="relative w-24 h-24">
                <img
                  ...
                  alt="New Upload"
                  className="w-4/6 h-full object-cover rounded-md"
                />
                <button
                  type="button"
                  className="absolute top-1 right-1 bg-red-500 text-white p-1 rounded-full hover:bg-red-600 transition"
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      {errors.itinerary?.[index - 1]?.meals && (
                        <p className="text-red-500">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={day.stay || ""}
                      onChange={(e) =>
                        handleItineraryChange(index, "stay", e.target.value)
                      }
                      className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <input
                      ...
                      value={day.transfer || ""}
                      onChange={(e) =>
                        handleItineraryChange(index, "transfer", e.target.value)
                      }
                      className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
