...
const BookingView: React.FC = () => {
  ...
  const onChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    showConfirm(
      "Change Trip Status",
      `Do you want to change the status to ${value}?`,
      async () => {
        if (booking) {
            ...
            booking.tripStatus === "Completed"
              ...
              : booking.tripStatus === "Cancelled" && "bg-gray-200 text-red-700"
                ...
                <div className="w-full max-w-[180px]">
                  <label
                    htmlFor="status"
                    className="block mb-1 text-xs font-medium text-gray-500 tracking-wide"
                  >
                    Booking Status
                  </label>
                  {isEditing ? (
                    ...
                    >
                      ...
                      <option value="In-progress" className="font-semibold">
                        In-Progress
                      </option>
                      <option value="Confirmed" className="font-semibold">
                        Confirmed
                      </option>
                    ...
                    <>
                      <div className="text-xs font-semibold text-gray-600">
                        <span className="rounded-full bg-orange-100 text-lg text-gray-700 font-semibold">
                          {booking.tripStatus}
                        </span>
                        <Pen
                          size={12}
              ...
              <div className="bg-white rounded-xl p-6 border shadow-sm">
                ...
                <div className="space-y-3 text-gray-700 text-sm">
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    <span className="rounded-full bg-green-200 font-medium">
