...
const verifyAgent = (id: string) =>{
   console.log(" Verify Agent !!",id);
   const agent = agentDataPending.find((agent => agent._id === id));
   console.log(" Corresponding Agent ::",agent);
        ...
        <> 
         ...
         <Pagination 
          ...
          <div className="flex items-center justify-center w-20 h-20 bg-red-100 rounded-full">
            ...
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01M21 12A9 9 0 1 1 3 12a9 9 0 0 1 18 0z"></path>
            </svg>
          </div>
