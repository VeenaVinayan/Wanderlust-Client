      ...
      { agentData.length>0 ? (
        ...
        <Table<Agent> 
                   ...
                   renderActions= {(agent) => (
                     <>
                        ...
                        >
                         ...
                         <button 
                               className="bg-gray-100 text-white px-4 m-2 py-2 rounded-lg font-semibold shadow-md hover:bg-gray-200 transition gap-2">
                               <ViewIcon color={'black'} size={10} />
                         </button>
                         <button 
                               className="bg-gray-100 text-white px-4 py-2 m-2 rounded-lg font-semibold shadow-md hover:bg-gray-200 transition gap-2">
         ...
         />
             ...
             <h2 className='text-3xl font-bold text-center text-gray-700 my-4'> No user avilable </h2>
          )
         }           
    </div>
  )
