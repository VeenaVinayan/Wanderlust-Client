    ...
    <div className="w-full max-w-lg bg-white shadow-xl rounded-2xl overflow-hidden">
        <div className="p-6">
          <div className="space-y-6">
           <div className="flex items-center space-x-4 border-b pb-4">
              ...
              <div className="w-full">
                ...
                <p className="mt-1 w-full bg-gray-100 text-gray-700 rounded-md p-2">{user?.name}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4 border-b pb-4">
          ...
          <div className="flex justify-between mt-6">
            <button className="px-4 py-2 border border-gray-300 bg-gray-700 rounded-lg text-white hover:bg-gray-500" onClick={togglePasswordModal}>
               Reset Password
            </button>
