...
import { endCallUser, setRoomIdUser, setShowIncomingVideoCall, setShowVideoCallUser, setVideoCallUser } from "../features/authentication/Video";
import { endCallAgent, setRoomId, setShowVideoCall, setVideoCall } from '../features/authentication/VideoCallAgent';
  ...
  useEffect(() => {
    ...
    useEffect(() => {
            ...
            socket.on("accepted-call", (data: IAcceptCall) => {
              console.log('accepted-call----> user',data)
           ...
           socket.on("agent-accept", (data: IAcceptCall) => {
              console.log("user accpted call for agent ---->",data);
